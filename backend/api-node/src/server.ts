...
import { initMongo } from './mongo/mongo.client';
import { listTodoEvents } from './audit/audit.service';

const app = express();
const port = Number(process.env.PORT || 3001);

// ORIGENS PERMITIDAS (default cobre 8080 / 4200)
const corsOrigins =
...
// Start: inicializa Mongo e sobe HTTP em 0.0.0.0 (para funcionar no container)
(async () => {
  await initMongo();
